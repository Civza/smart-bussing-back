...
public class RegistroLugarMapper {
    ...
    public RegistroLugarMapper(ContratoRepository contratoRepository,
    ...
    public Empresa toEmpresa(RegistroLugarDTO registroLugar) {
        Optional<Empresa> empresa1 = empresaRepository.findByEmail(registroLugar.getCorreoEmpresa());
        ...
        if (registroLugar.getCorreoEmpresa() == null || registroLugar.getCorreoEmpresa().isEmpty()) {
        ...
        empresa.setEmail(registroLugar.getCorreoEmpresa());
        empresa.setName(registroLugar.getNombreEmpresa());
        empresa.setPais("Mexico");
        empresa.setMetodoPago("Efectivo");
    ...
    public Contrato toContrato(RegistroLugarDTO registroLugar){
        ...
        contrato.setFechaInicio(registroLugar.getFechaInicio());
        contrato.setFechaFin(registroLugar.getFechaFin());
